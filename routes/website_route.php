...
Route::get("/{lang}/{type}" , "QuestionController@index")->where("lang" , "en|ar|fr")->where("type" , "1|2")->middleware("loginFromCookie");
Route::get("/{lang}/{type}" , "QuestionController@index")->where("lang" , "en|ar|fr")->where("type" , "1|2")->middleware("loginFromCookie");
Route::get("/{lang}/index/{type}" , "QuestionController@index")->where("lang" , "en|ar|fr")->where("type" , "1|2")->middleware("loginFromCookie");
...
Route::get("/{lang}/posts/{type}" , "PostController@index")->where("lang" , "en|ar|fr")->where("type" , "1|2")->middleware("loginFromCookie");
